  ...
  <main>
    ...
    <div v-if="docteur.photo">
      ...
      <div class="photo-container">
        <img :src="docteur.photo.url" alt="Photo du docteur" />
        <div class="photo-details">
          <p><strong>Nom du fichier :</strong> {{ docteur.photo.filename }}</p>
          <p><strong>Type MIME :</strong> {{ docteur.photo.mimeType }}</p>
          <p><strong>Taille :</strong> {{ formatFileSize(docteur.photo.size) }}</p>
        </div>
      </div>
    </div>
  </main>
...
const docteur = ref({
  ...
  photo: null // La photo inclura des détails comme filename, mimeType, size
});
