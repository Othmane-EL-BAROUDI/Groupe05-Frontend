...
//     reader.onload = () => {
//       docteur.value.photo = reader.result; // Convertit la photo en Base64
//       console.log("Photo téléchargée :", docteur.value.photo);
//     };
